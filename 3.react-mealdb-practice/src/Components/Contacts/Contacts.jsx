  ...
  return (
    <div>
      ...
      <article className="bg-slate-500 text-cyan-400 font-medium text-4xl p-10 ">
        ...
        about us:</article> 
       <article className="p-6 m-2"> Name: Our restaurant is called "The Chefs Table Cuisine". Our focus
        is on serving delicious, high-quality dishes that are bursting with
        flavor and spices from around the world.</article> 
       <article className="p-6 m-2"> Address: We are located at 58,
       ...
       <article className="p-6 m-2">  Our Team: Our team of chefs and servers are passionate
        ...
        <article className="p-6 m-2"> Our Menu: Our menu features a wide range of dishes
       ...
       <article className="p-6 m-2"> Atmosphere: Our restaurant is designed to create a warm and welcoming
