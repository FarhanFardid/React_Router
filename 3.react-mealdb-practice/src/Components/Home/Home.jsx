    ...
    <div>
      ...
      <article className="bg-slate-500 text-white text-4xl p-10 ">
        <article className="p-3 ">
          ...
          nourish the body but also delight the senses, which is why we use only
        ...
        <article className="p-3 ">
          ...
          but also healthy and nutritious. We source our ingredients locally
        ...
        <article className="p-3 ">
          ...
          requests and ensure that your visit is enjoyable and hassle-free. In
          addition to our regular menu, we also offer daily specials that
          showcase the best seasonal ingredients and flavors. From fresh seafood
          to juicy steaks, our specials menu offers a range of dishes that are
          sure to tantalize your taste buds. We believe that good food is meant
          to be shared, which is why we offer catering services for events of
          all sizes. From corporate luncheons to weddings and private parties,
          our team can create a customized menu that fits your specific needs
          and budget. At our restaurant, we strive to provide our customers with
          an exceptional dining experience that leaves a lasting impression.
          Whether you're a regular or a first-time visitor, we welcome you to
          our restaurant and look forward to serving you soon!
        </article>
      </article>
    </div>
  );
